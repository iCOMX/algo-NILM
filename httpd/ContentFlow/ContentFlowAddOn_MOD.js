/*  ContentFlowAddOn_MOD, version 2.0 
 ...
 * All values are the MOD values of ContentFlow.
 *
 ...
 * 2. Change the string 'MOD' in the 'new ContentFlowAddOn' line to 'ADDONNAME'
...
new ContentFlowAddOn ('MOD', {
     ...
     * Will overwrite the MOD configuration (or configuration of previously loaded AddOns).
